...
- **[mlxtend](http://rasbt.github.io/mlxtend/)** - Machine Learning Extensions: Pattern Mining, Model Evaluation, Plotting
...
- **[dtreeviz](https://github.com/parrt/dtreeviz)** - Decision Tree Visualisierung und Interpretation

## Explainable AI (XAI)

- **[SHAP](https://shap.readthedocs.io/)** - SHapley Additive exPlanations - Modellinterpretation mit Shapley Values
- **[LIME](https://github.com/marcotcr/lime)** - Local Interpretable Model-agnostic Explanations
- **[ELI5](https://eli5.readthedocs.io/)** - Explain Like I'm 5 - Model Interpretation Library
- **[InterpretML](https://interpret.ml/)** - Interpretable Machine Learning (Microsoft Research)
