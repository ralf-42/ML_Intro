...
| ---------------------------------- | :--------------------------: | :--------------------------: | :--------------------------: | :-------------------------: | ------------------------------------------------------------------------------------ |
| **Supervised Learning**            |                              |                              |                              |                             |                                                                                      |
| Decision Tree Classifier/Regressor |              Ja              |             Nein             |              Ja              |            Nein             | Für ältere Versionen oder vorgelagerte Pipeline-Schritte trotzdem imputieren.        |
...
| Autoencoder                        |             Nein             |              Ja              |              Ja              |             Ja              | Bei Anomalieerkennung sind Ausreißer oft Zielsignal, nicht automatisch Fehler.       |
| **Übrige**                         |                              |                              |                              |                             |                                                                                      |
