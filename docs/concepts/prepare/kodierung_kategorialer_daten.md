...
Kodierung und Skalierung sollten **getrennt** auf Trainings- und Testdaten erfolgen:
...
# Spalten definieren
nominal_cols = ['farbe', 'marke']
ordinal_cols = ['bildung', 'zufriedenheit']

# ColumnTransformer für unterschiedliche Kodierungen
...
### 3. Unbekannte Kategorien behandeln

```python
# OneHotEncoder: Unbekannte Kategorien ignorieren
encoder = OneHotEncoder(handle_unknown='ignore')

# OrdinalEncoder: Unbekannte Kategorien auf speziellen Wert setzen
encoder = OrdinalEncoder(
