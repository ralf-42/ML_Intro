...
- **[Grundlagen](concepts/01_grundlagen.html)** – *Wie beginnt der ML-Workflow sinnvoll?* Einstieg in Lernparadigmen, Workflow und praktische Arbeitsweisen.
...
- **[Prepare](concepts/02_prepare.html)** – *Wie werden Rohdaten modellfähig gemacht?* Datenaufbereitung, Transformation und typische Fehlerquellen.
- **[Prepare nach Modell](concepts/prepare/prepare_nach_modell.html)** – *Welche Vorverarbeitung braucht welcher Algorithmus?* Entscheidungshilfe für die im Kurs eingesetzten Modelle.
...
- **[Modeling](concepts/03_modeling.html)** – *Welches Modell passt zur Aufgabe?* Klassische Verfahren, Ensembles, Deep Learning und AutoML im Vergleich.
...
- **[Evaluate](concepts/04_evaluate.html)** – *Wie wird Modellqualität belastbar gemessen?* Bewertungslogik und typische Fehlinterpretationen.
